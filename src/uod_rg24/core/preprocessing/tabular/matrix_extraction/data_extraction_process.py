...
from uod_rg24.models.preprocessing.tabular.matrix_extraction.data_extraction_process_models import (
    DataExtractionProcessInfoModel,
...
def data_extraction_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    data_extraction_process_request: DataExtractionProcessRequestModel,
) -> DataExtractionProcessResponseModel:
    del data_extraction_process_request
    ...
    data_extraction_process_info = DataExtractionProcessInfoModel()

    processing_completed_at = utc_now()

    return DataExtractionProcessResponseModel(
        success=True,
        ...
        dataExtractionProcessInfo=data_extraction_process_info,
        steps=steps,
    )
