...
def detect_classification_type_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    detect_classification_type_process_request: DetectClassificationTypeProcessRequestModel,
) -> DetectClassificationTypeProcessResponseModel:
    del detect_classification_type_process_request
    ...
    detect_classification_type_process_info = DetectClassificationTypeProcessInfoModel()

    processing_completed_at = utc_now()

    return DetectClassificationTypeProcessResponseModel(
        success=True,
        ...
        detectClassificationTypeProcessInfo=detect_classification_type_process_info,
        steps=steps,
    )
