...
from uod_rg24.models.preprocessing.tabular.class_labels.assign_class_labels_process_models import (
    AssignClassLabelsProcessInfoModel,
...
def assign_class_labels_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    assign_class_labels_process_request: AssignClassLabelsProcessRequestModel,
) -> AssignClassLabelsProcessResponseModel:
    del assign_class_labels_process_request
    ...
    assign_class_labels_process_info = AssignClassLabelsProcessInfoModel()

    processing_completed_at = utc_now()

    return AssignClassLabelsProcessResponseModel(
        success=True,
        ...
        assignClassLabelsProcessInfo=assign_class_labels_process_info,
        steps=steps,
    )
