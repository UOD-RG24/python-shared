...
from uod_rg24.models.preprocessing.tabular.class_labels.extract_subtype_labels_process_models import (
    ExtractSubtypeLabelsProcessInfoModel,
...
def extract_subtype_labels_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    extract_subtype_labels_process_request: ExtractSubtypeLabelsProcessRequestModel,
) -> ExtractSubtypeLabelsProcessResponseModel:
    del extract_subtype_labels_process_request
    ...
    extract_subtype_labels_process_info = ExtractSubtypeLabelsProcessInfoModel()

    processing_completed_at = utc_now()

    return ExtractSubtypeLabelsProcessResponseModel(
        success=True,
        ...
        extractSubtypeLabelsProcessInfo=extract_subtype_labels_process_info,
        steps=steps,
    )
