...
from uod_rg24.models.preprocessing.tabular.feature_selection.remove_no_signal_process_models import (
    RemoveNoSignalProcessInfoModel,
...
def remove_no_signal_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    remove_no_signal_process_request: RemoveNoSignalProcessRequestModel,
) -> RemoveNoSignalProcessResponseModel:
    del remove_no_signal_process_request
    ...
    remove_no_signal_process_info = RemoveNoSignalProcessInfoModel()

    processing_completed_at = utc_now()

    return RemoveNoSignalProcessResponseModel(
        success=True,
        ...
        removeNoSignalProcessInfo=remove_no_signal_process_info,
        steps=steps,
    )
