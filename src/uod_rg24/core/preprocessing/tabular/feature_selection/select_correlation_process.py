...
from uod_rg24.models.preprocessing.tabular.feature_selection.select_correlation_process_models import (
    SelectCorrelationProcessInfoModel,
...
def select_correlation_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    select_correlation_process_request: SelectCorrelationProcessRequestModel,
) -> SelectCorrelationProcessResponseModel:
    del select_correlation_process_request
    ...
    select_correlation_process_info = SelectCorrelationProcessInfoModel()

    processing_completed_at = utc_now()

    return SelectCorrelationProcessResponseModel(
        success=True,
        ...
        selectCorrelationProcessInfo=select_correlation_process_info,
        steps=steps,
    )
