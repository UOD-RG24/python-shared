...
from uod_rg24.models.preprocessing.tabular.feature_selection.remove_low_variance_process_models import (
    RemoveLowVarianceProcessInfoModel,
...
def remove_low_variance_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    remove_low_variance_process_request: RemoveLowVarianceProcessRequestModel,
) -> RemoveLowVarianceProcessResponseModel:
    del remove_low_variance_process_request
    ...
    remove_low_variance_process_info = RemoveLowVarianceProcessInfoModel()

    processing_completed_at = utc_now()

    return RemoveLowVarianceProcessResponseModel(
        success=True,
        ...
        removeLowVarianceProcessInfo=remove_low_variance_process_info,
        steps=steps,
    )
