...
from uod_rg24.models.preprocessing.tabular.feature_selection.select_top_features_process_models import (
    SelectTopFeaturesProcessInfoModel,
...
def select_top_features_process(
    blob_service_client: BlobServiceClient,
    input_blob: InputModel,
    output_blob: OutputModel,
    select_top_features_process_request: SelectTopFeaturesProcessRequestModel,
) -> SelectTopFeaturesProcessResponseModel:
    del select_top_features_process_request
    ...
    select_top_features_process_info = SelectTopFeaturesProcessInfoModel()

    processing_completed_at = utc_now()

    return SelectTopFeaturesProcessResponseModel(
        success=True,
        ...
        selectTopFeaturesProcessInfo=select_top_features_process_info,
        steps=steps,
    )
