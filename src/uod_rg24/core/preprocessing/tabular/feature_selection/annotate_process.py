...
def annotate_process(
    ...
    annotate_process_request: AnnotateProcessRequestModel,
) -> AnnotateProcessResponseModel:
    del annotate_process_request
    ...
    annotate_process_info = AnnotateProcessInfoModel()

    processing_completed_at = utc_now()

    return AnnotateProcessResponseModel(
        success=True,
        ...
        annotateProcessInfo=annotate_process_info,
        steps=steps,
    )
