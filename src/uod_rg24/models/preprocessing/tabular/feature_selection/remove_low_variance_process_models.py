...
class RemoveLowVarianceProcessInfoModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )


class RemoveLowVarianceProcessRequestModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
        extra="forbid",
    )
...
class RemoveLowVarianceProcessResponseModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    remove_low_variance_process_info: RemoveLowVarianceProcessInfoModel = Field(
        alias="removeLowVarianceProcessInfo",
    )
