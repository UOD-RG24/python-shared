...
class SelectTopFeaturesProcessInfoModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )


class SelectTopFeaturesProcessRequestModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
        extra="forbid",
    )
...
class SelectTopFeaturesProcessResponseModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    select_top_features_process_info: SelectTopFeaturesProcessInfoModel = Field(
        alias="selectTopFeaturesProcessInfo",
    )
