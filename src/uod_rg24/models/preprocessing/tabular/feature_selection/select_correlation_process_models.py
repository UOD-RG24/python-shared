...
class SelectCorrelationProcessInfoModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )


class SelectCorrelationProcessRequestModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
        extra="forbid",
    )
...
class SelectCorrelationProcessResponseModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    ...
    select_correlation_process_info: SelectCorrelationProcessInfoModel = Field(
        alias="selectCorrelationProcessInfo",
    )
