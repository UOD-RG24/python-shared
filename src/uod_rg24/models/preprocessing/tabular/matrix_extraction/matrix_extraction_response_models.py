...
from uod_rg24.models.preprocessing.tabular.matrix_extraction.data_extraction_process_models import (
    ...
    DataExtractionProcessResponseModel,
)
...
class MatrixExtractionResponseModel(
    BaseModel,
    ...
    matrix_extraction_process_response: TProcessResponse = Field(
        alias="matrixExtractionProcessResponse",
        description="Optional detailed result of the matrix extraction operation.",
    )
...
class MatrixExtractionSuccessResponseModel(
    MatrixExtractionResponseModel[
        TProcessRequest,
        TProcessResponse,
        TInput,
        TOutput,
    ...
    success: bool = True
    matrix_extraction_process_request: TProcessRequest
    matrix_extraction_process_response: TProcessResponse
    input_blob: TInput
    output_blob: TOutput
    error: None = None


class MatrixExtractionErrorResponseModel(
    MatrixExtractionResponseModel[
        None,
        None,
        None,
    ...
    success: bool = False
    matrix_extraction_process_request: None = None
    matrix_extraction_process_response: None = None
    input_blob: None = None
    output_blob: None = None


class DataExtractionResponseModel(
    MatrixExtractionSuccessResponseModel[
        DataExtractionProcessRequestModel,
        DataExtractionProcessResponseModel,
        InputModel,
        OutputModel,
