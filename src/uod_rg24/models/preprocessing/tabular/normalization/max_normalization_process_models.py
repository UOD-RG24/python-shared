...
class MaxNormalizationInfoModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )

    norm: Literal["max"] = "max"
...
class MaxNormalizationProcessRequestModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
        extra="forbid",
    )
...
class MaxNormalizationProcessResponseModel(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
