...
class SampleSelectionResponseModel(
    BaseModel,
    ...
    sample_selection_process_request: TProcessRequest = Field(
        alias="sampleSelectionProcessRequest",
        description="Optional additional details specific to the sample selection request.",
    )
    sample_selection_process_response: TProcessResponse = Field(
        alias="sampleSelectionProcessResponse",
        description="Optional detailed result of the sample selection operation.",
    )
...
class SampleSelectionSuccessResponseModel(
    SampleSelectionResponseModel[
        TProcessRequest,
        TProcessResponse,
        TInput,
        TOutput,
    ...
    success: bool = True
    sample_selection_process_request: TProcessRequest
    sample_selection_process_response: TProcessResponse
    input_blob: TInput
    output_blob: TOutput
    error: None = None


class SampleSelectionErrorResponseModel(
    SampleSelectionResponseModel[
        None,
        None,
        None,
    ...
    success: bool = False
    sample_selection_process_request: None = None
    sample_selection_process_response: None = None
    input_blob: None = None
    output_blob: None = None


class RetainCompleteSamplesResponseModel(
